...
import featureImg from "../assets/svg/whyus.svg";
import { FaCircleCheck } from "react-icons/fa6";

function WhyUs() {
  return (
    <div className="row g-0 p-4 my-5 align-items-center" id="whyus">
          ...
          <div className="d-flex align-items-start gap-3">
            ...
            <div>
              ...
              <p className="ps-2" style={{ color: theme.secondary }}>
                ...
                hands-on experience in the tech industry. We bring unparalleled
                expertise to every project, ensuring efficiency and time
          ...
          <div className="d-flex align-items-start gap-3">
            ...
            <div>
              ...
              <p className="ps-2" style={{ color: theme.secondary }}>
                ...
                your specific needs. Our commitment to quality and time
                guarantees that your tech flow run smoothly and effectively.
              </p>
            </div>
          </div>
          <div className="d-flex align-items-start gap-3">
